...
const rawCatalogue: PointerCatalogueEntry[] = [
    ...
    { template: "/nodes/[node]/weights/[weight]", label: "Node · morph target weight", category: "Nodes", type: t.FLOAT, readOnly: false },
    ...
    { template: "/nodes/[node]/mesh", label: "Node · mesh", category: "Nodes", type: t.REF, readOnly: true },
    { template: "/nodes/[node]/camera", label: "Node · camera", category: "Nodes", type: t.REF, readOnly: true },
    { template: "/nodes/[node]/parent", label: "Node · parent", category: "Nodes", type: t.REF, readOnly: true },
    { template: "/nodes/[node]/children/[child]", label: "Node · child", category: "Nodes", type: t.REF, readOnly: true },
    { template: "/nodes/[node]/children.length", label: "Node · children count", category: "Nodes", type: t.INT, readOnly: true },
    { template: "/nodes/[node]/weights.length", label: "Node · morph target weights count", category: "Nodes", type: t.INT, readOnly: true },
    ...
    // ---- Meshes ----
    { template: "/meshes/[mesh]/weights/[weight]", label: "Mesh · morph target weight", category: "Meshes", type: t.FLOAT, readOnly: false },
    { template: "/meshes/[mesh]/weights.length", label: "Mesh · morph target weights count", category: "Meshes", type: t.INT, readOnly: true },
    { template: "/meshes/[mesh]/primitives.length", label: "Mesh · primitives count", category: "Meshes", type: t.INT, readOnly: true },
    { template: "/meshes/[mesh]/primitives/[primitive]/material", label: "Mesh primitive · material", category: "Meshes", type: t.REF, readOnly: true },
    ...
    { template: "/materials/[material]/doubleSided", label: "Material · double sided", category: "Materials", type: t.BOOLEAN, readOnly: false },
    ...
    { template: "/skins.length", label: "Count · skins", category: "Scene", type: t.INT, readOnly: true },
    { template: "/skins/[skin]/joints.length", label: "Skin · joints count", category: "Scene", type: t.INT, readOnly: true },
    { template: "/skins/[skin]/joints/[joint]", label: "Skin · joint", category: "Scene", type: t.REF, readOnly: true },
    { template: "/skins/[skin]/skeleton", label: "Skin · skeleton root", category: "Scene", type: t.REF, readOnly: true },
    { template: "/scene", label: "Active scene", category: "Scene", type: t.INT, readOnly: true },
    { template: "/scenes.length", label: "Count · scenes", category: "Scene", type: t.INT, readOnly: true },
    { template: "/scenes/[scene]/nodes.length", label: "Scene · root nodes count", category: "Scene", type: t.INT, readOnly: true },
    { template: "/scenes/[scene]/nodes/[node]", label: "Scene · root node", category: "Scene", type: t.REF, readOnly: true },
